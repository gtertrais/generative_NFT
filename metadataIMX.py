...
BASE_IMAGE_URL = "ipfs://QmZYiNE9F7HR7Xq5kS1sX289DyYh43RZu9Vn5DYiqaB643"
BASE_NAME = "L'Artisan Français #"

BASE_JSON = {
    "id": "",
    "name": BASE_NAME,
    "description": "Sorti le 18 décembre 2021 à 19.99€, l’Artisan Français est le premier NFT de Gaspard & Joseph. Il s’agit de 150 variantes du logo de G&J uniques et autogénérés avec des attributs issus de la culture française. Créé et édité par Gaspard & Joseph, l’Artisan offre des avantages exclusifs à ses détenteurs sur certains drops et réserve bien d’autres surprises… Gaspard & Joseph™",
    "number_of_mints": "150",
...
def generate_paths(edition_name):
    ...
    json_path = os.path.join(edition_path, 'jsonIMX')
